...
- ps `微信升级后`，`resourceId可能会发生变化`，你需要使用你手机上微信版本的 resourceId
...
- 我们在做一些数据爬取时，使用 mysql 直接存储到数据库会更方便，软件已经内置了 mysql 库，可以参考使用
- mysql 库的文档地址：[https://www.npmjs.com/package/mysql](https://www.npmjs.com/package/mysql)
